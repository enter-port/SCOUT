...
> **历史归档（2026-09-24 整理）。** 正文保留当时的计划、参数与判断，不作为当前实现规范；其中“权威”“待实现”“默认”等措辞仅适用于历史时点。当前实现见 [idea_notes.md](../idea_notes.md)，运行入口见 [scripts/README.md](../../scripts/README.md)。
...
- 配置 / 超参 / 数据格式详见 `experiments/experiment_log.md`（历史路径 `../experiments/experiment_log.md`，当前仓库未收录） Part 1。

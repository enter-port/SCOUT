...
from scout.policy.diffusion import DiffusionUNetPolicy
from scout.policy.img_encoder.multi_image_obs_encoder import MultiImageObsEncoder
# NOTE: EncoderMLP is taken from scout.model.mlp (ported in Phase 1), NOT re-transported
# from SOE's policy.vqvae_modules.vqvae. The block is identical; this avoids pulling in
# the VQ-VAE stack which SCOUT stage-1 does not use.

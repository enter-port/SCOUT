...
def _smoke_vec():
    ...
    # schema check ("first_traj" added by the 2026-08-23 rescue dyn-rule --
    # the expected set here had drifted stale and failed every smoke since)
    for r in expl_vec:
        assert set(r.keys()) == {"solved", "n_tries", "successful_trajs",
                                 "all_trajs", "first_traj",
                                 "baseline_solved"}, "schema"

#!/usr/bin/env bash
# rand_full.sh <tag> <guide> <gpu> [extra run_rollout args...]
#   Full pass@10 (user protocol: scenes 42-141 = 100 fixed seed-42 scenes),
#   rescue x10, env50, base DP+dyn, --no-wandb.  Compare against 方案三
#   baseline band pass@10 = 0.76-0.78 (rescued 14/19).  SCALE env var sets
#   exploration.guidance_scale (default 3.0).  Output: scout-rand/data/rand/<tag>/.
set -u

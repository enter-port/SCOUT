#!/bin/bash
# SQUARE s233 orbit-native 6-round chain (user order 2026-09-01).
...
# 20260826-112119 + core_rebuild/square_core_s233.hdf5), linked/copied into
...
# Usage: GPU=<id> bash /tmp/sq_orb_chain.sh
set -uo pipefail

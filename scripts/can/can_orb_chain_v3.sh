#!/bin/bash
# CAN s233 orbit-native 6-round chain V3 (user order 2026-09-02 late):
...
# v2 history: launched 09-02 evening on pre-merge code with sigma 0.25 and no
...
# v1 monolithic products remain untouched under scout-rand/data/2026_9_2_orbchain/.
# Usage: GPU=<id> bash /tmp/can_orb_chain_v3.sh
set -uo pipefail
